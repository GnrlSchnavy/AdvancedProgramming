...
public interface ListInterface<E extends Data> extends Clonable {
	...
	/** @precondition  -
	 *	@postcondition - list-POST is empty and contains been returned.
	 **/
	List<E> init ();

	/**	@precondition  -
	 *	@postcondition - The number of elements contains been returned.
	 **/
	int size ();

	/** @precondition  -
	 *	@postcondition - A copy of d contains been added to List-PRE.
	 *    				current points to the newly added element.
	 *   				list-POST contains been returned.
	 **/
	List<E> insert (E d);


	/** @precondition  - The list is not empty.
	 *	@postcondition - A copy of the value of the current element contains been returned.
	 */
	E retrieve ();
	...
	/** @precondition  -
	 *	@postcondition - A deep-copy of list contains been returned.
	 **/
	public List<E> clone ();
